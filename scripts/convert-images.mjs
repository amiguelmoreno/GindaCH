...
const JOBS = [
  ...
  { src: "proyectos Ginda antes y despues/fachada casa grande despues.png", width: 700, quality: 60 },
  { src: "proyectos Ginda antes y despues/fachada casa grande despues.png", out: "ba/fachada-casa-grande-despues-430.webp", width: 430, quality: 60 },
  ...
  { src: "proyectos Ginda antes y despues/fachada piso despues.jpeg",       width: 700, quality: 60 },
  { src: "proyectos Ginda antes y despues/fachada piso despues.jpeg",       out: "ba/fachada-piso-despues-430.webp",       width: 430, quality: 60 },

  // Project examples – displayed up to ~377px desktop / 375px mobile → 800px @2x retina
  { src: "beispiel/example-1-house-classic.jpg",  width: 800, quality: 55 },
  { src: "beispiel/example-2-house-modern.jpg",   width: 800, quality: 55 },
  { src: "beispiel/example-3-showroom-lounge.jpg",width: 800, quality: 55 },
  { src: "beispiel/example-4-bedroom-white.jpg",  width: 800, quality: 55 },
  { src: "beispiel/example-5-showroom-wide.jpg",  width: 800, quality: 55 },
  { src: "beispiel/example-6-byd-wall.jpg",       width: 800, quality: 55 },
  { src: "beispiel/example-7-kitchen-blue.jpg",   width: 800, quality: 55 },
  { src: "beispiel/example-8-garage-red.jpg",     width: 800, quality: 55 },
  { src: "beispiel/example-9-living-dark.jpg",    width: 800, quality: 55 },
];
